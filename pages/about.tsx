		...
		<div>
			...
			<Container>
				<AboutSection>
					...
					<AboutText>
						From dabbling with with Instagram bots using a Python script, to
						creating visual graphs using R and R Studio. I always wondered how
						code was used to create programs. Before becoming a developer, I was
						into music production and built my first website using WordPress to
						sell my music online. It was easy to make a website but, trying to
						do some advanced designs required coding. I was scared to try
						because I though coding was complicated.
						<AboutText>
						...
						<AboutText>
							...
							I don't regret taking that chance and believing in myself. I am so
